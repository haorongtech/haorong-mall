package com.haorong.cloud.generator.utils;

import cn.hutool.core.util.StrUtil;
import com.haorong.cloud.common.core.util.SpringUtils;
import com.haorong.cloud.generator.config.GenConfig;
...
public class GenUtils {
	...
	public static String convertClassName(String tableName) {
		...
		boolean autoRemovePre = genConfig.getAllowOverwrite();
		String tablePrefix = genConfig.getTablePrefix();
		if (autoRemovePre && StringUtils.hasText(tablePrefix)) {
	...
	public static String getDbType(String columnType) {
		if (StrUtil.indexOf(columnType, "(", 0, false) > 0) {
	...
	public static Integer getColumnLength(String columnType) {
		if (StrUtil.contains(columnType, "(")) {
			...
			return StrUtil.isNotBlank(length) ? Integer.valueOf(length) : 0;
		}
		else {
			return 0;
		}
