...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'haorong-boot', '单体执行器', 0, 'http://192.168.31.89:9009/', '2025-05-24 21:47:41');
...
-- ----------------------------
INSERT INTO `xxl_job_info` VALUES (2, 1, '扫描过期的优惠券', '2025-05-24 21:37:43', '2025-05-24 21:38:16', 'admin', '', 'FIX_RATE', '10', 'DO_NOTHING', 'FIRST', 'scanExpiredCouponsJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2025-05-24 21:37:43', '', 1, 1748094481145, 1748094491145);
INSERT INTO `xxl_job_info` VALUES (3, 1, '扫描超时未支付订单', '2025-05-24 21:38:02', '2025-05-24 21:38:13', 'admin', '', 'FIX_RATE', '10', 'DO_NOTHING', 'FIRST', 'orderCancelJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2025-05-24 21:38:02', '', 1, 1748094478457, 1748094488457);
...
CREATE TABLE `xxl_job_log`  (
                                ...
                                INDEX `I_jobid_jobgroup`(`job_id` ASC, `job_group` ASC) USING BTREE,
                                INDEX `I_job_id`(`job_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `xxl_job_log_report` VALUES (1, '2025-05-24 00:00:00', 0, 159, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (2, '2025-05-23 00:00:00', 0, 0, 0, NULL);
INSERT INTO `xxl_job_log_report` VALUES (3, '2025-05-22 00:00:00', 0, 0, 0, NULL);
...
-- ----------------------------
INSERT INTO `xxl_job_registry` VALUES (2, 'EXECUTOR', 'haorong-boot', 'http://192.168.31.89:9009/', '2025-05-24 21:47:54');
