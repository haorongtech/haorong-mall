ALTER TABLE haorong_pay.`pay_config`
...
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003264361078786', '代码生成', NULL, '/platform/generator', NULL, '1881217134381326338', 'carbon:ibm-cloud-code-engine', NULL, 160, '0', '2025-11-05 17:30:51', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003505764245505', '数据源管理', NULL, '/datasource', NULL, '1986003264361078786', 'carbon:settings', 'gen/datasource/index', 10, '0', '2025-11-05 17:31:49', '2025-11-05 18:00:40', '0', '0', 'sys_key', 'system', 'system');
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003578032103426', '数据源列表', 'gen:datasource:page', NULL, NULL, '1986003505764245505', NULL, NULL, 1, '1', '2025-11-05 17:32:06', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003636857217026', '通过id查询数据源', 'gen:datasource:get', NULL, NULL, '1986003505764245505', NULL, NULL, 1, '1', '2025-11-05 17:32:20', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003694830886913', '数据源新增', 'gen:datasource:add', NULL, NULL, '1986003505764245505', NULL, NULL, 1, '1', '2025-11-05 17:32:34', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003761939750914', '数据源修改', 'gen:datasource:edit', NULL, NULL, '1986003505764245505', NULL, NULL, 1, '1', '2025-11-05 17:32:50', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986003823453413377', '数据源删除', 'gen:datasource:del', NULL, NULL, '1986003505764245505', NULL, NULL, 1, '1', '2025-11-05 17:33:04', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986010716532064257', '数据表管理', NULL, '/gen-table', NULL, '1986003264361078786', 'carbon:list', 'gen/gen-table/index', 20, '0', '2025-11-05 18:00:28', NULL, '0', '0', 'sys_key', 'system', NULL);
INSERT INTO haorong_upms.`sys_menu` VALUES ('1986060144760565762', '数据表列表', 'gen:gen-table:page', NULL, NULL, '1986010716532064257', NULL, NULL, 1, '1', '2025-11-05 21:16:52', NULL, '0', '0', 'sys_key', 'system', NULL);

INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280725', '1881232177484574722', '1986003264361078786', '2025-11-05 21:17:16', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280726', '1881232177484574722', '1986003505764245505', '2025-11-05 21:17:16', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280727', '1881232177484574722', '1986003578032103426', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280728', '1881232177484574722', '1986003636857217026', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280729', '1881232177484574722', '1986003694830886913', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280730', '1881232177484574722', '1986003761939750914', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280731', '1881232177484574722', '1986003823453413377', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280732', '1881232177484574722', '1986010716532064257', '2025-11-05 21:17:17', '1881232176465358849');
INSERT INTO haorong_upms.`sys_role_menu` VALUES ('1986060209191280733', '1881232177484574722', '1986060144760565762', '2025-11-05 21:17:17', '1881232176465358849');


-- 代码生成相关库
create database `haorong_gen` default character set utf8mb4 collate utf8mb4_general_ci;



DROP TABLE IF EXISTS haorong_gen.`gen_table`;
CREATE TABLE haorong_gen.`gen_table`  (
...
DROP TABLE IF EXISTS haorong_gen.`gen_table_column`;
CREATE TABLE haorong_gen.`gen_table_column`  (
...
-- ----------------------------
DROP TABLE IF EXISTS haorong_gen.`gen_data_source`;
CREATE TABLE haorong_gen.`gen_data_source`  (
