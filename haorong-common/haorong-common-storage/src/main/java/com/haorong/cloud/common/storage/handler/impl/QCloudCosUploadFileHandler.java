 ...
 * @author haorong
 */
@Component("uploadFile2")
public class QCloudCosUploadFileHandler extends AbstractUploadFileHandler {

	@Override
	public String doUploadFile(StorageConfig storageConfig, File file) {
		// 使用高级接口必须先保证本进程存在一个 TransferManager 实例，如果没有则创建
		// 详细代码参见本页：高级接口 -> 创建 TransferManager
		TransferManager transferManager = createTransferManager(storageConfig);
	...
	public TransferManager createTransferManager(StorageConfig storageConfig) {
